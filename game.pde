...
class Game extends State {
  ...
  Map map;
  Player[] players;
  int selectedCellX, selectedCellY, sidePanelX, sidePanelY, sidePanelW, sidePanelY;
  ...
  void updateSidePanelElementsSizes() {
    ...
    sidePanelY = round(mapElementHeight)-70;
    float taskRowHeight = ((TaskManager)getElement("tasks", "party management")).getH(new PGraphics());
    getPanel("land management").transform(sidePanelX, sidePanelY, sidePanelW, round(sidePanelY*0.15));
    getPanel("party management").transform(sidePanelX, sidePanelY+round(sidePanelY*0.15)+bezel, sidePanelW, round(sidePanelY*0.85)-bezel*3);
    ((NotificationManager)(getElement("notification manager", "default"))).transform(bezel, bezel, sidePanelW, round(sidePanelY*0.2)-bezel*2);
    ...
    ((Button)getElement("disband button", "party management")).transform(sidePanelW-bezel-80, int(sidePanelY*0.85-bezel*4-30), 80, 30);
  ...
  void drawPartyManagement(PGraphics panelCanvas) {
    ...
    float barY = sidePanelY + 13*jsManager.loadFloatSetting("text scale") + sidePanelY*0.15 + bezel*2;
