...
class Menu extends State{
  ...
  Menu(){
    ...
    addElement("water level", new Slider(width-buttonW*2-buttonP*2, buttonH*2+buttonP*3, buttonW, buttonH, color(0, 255, 0), bColour, color(150), color(0), 0, 0.5, 1, 10, 10, 0.01, true, "Water Level"), "new game");
