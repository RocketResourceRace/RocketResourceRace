...
class Menu extends State{
  ...
  Menu(){
    ...
    addElement("map size", new Slider(width-buttonW-buttonP, buttonH*2+buttonP*3, buttonW, buttonH, color(0, 255, 0), bColour, color(150), color(0), 100, mapSize, 300, 5, 20, 10, true, "Map Size"), "new game");
